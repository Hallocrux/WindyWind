...
ENTRY_REL_PATH = "src/try/016_micn_loco/run_micn_loco.py"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="发布 MICN windywind 实验到 Kaggle。")
    add_publish_args(
        parser,
        default_code_slug="windywind-micn-code",
        default_kernel_slug="windywind-micn-runner",
    )
...
def main() -> None:
    ...
    run_dir = make_run_dir(TRY_NAME, "micn")
    ...
    kernel_dir = prepare_kernel_dir(
        ...
        kernel_id=kernel_id,
        kernel_title="windywind MICN runner",
            ...
            "datasets": [
                {
                    ...
                    "dataset_title": "windywind MICN code payload",
                    "version_notes": "MICN code payload update",
    ...
    print(f"MICN Kaggle 发布目录已准备：{run_dir}")
